...
//    [self.tableView registerNib:[UINib nibWithNibName:@"DemoVC14Cell" bundle:nil] forCellReuseIdentifier:@"DemoVC14Cell"];
    ...
    [self.tableView registerClass:[ArticleTableViewCell class] forCellReuseIdentifier:@"DemoVC14Cell"];
}
...
- (void)creatModelsWithCount:(NSInteger)count
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        model.titleStr = textArray[nameRandomIndex];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ArticleTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"DemoVC14Cell"];
...
{
    ArticleModel *demoVC14Modelodel = self.modelsArray[indexPath.row];
    
    return [tableView cellHeightForIndexPath:indexPath model:demoVC14Modelodel keyPath:@"model" cellClass:[ArticleTableViewCell class] contentViewWidth:[self cellContentViewWith]];
